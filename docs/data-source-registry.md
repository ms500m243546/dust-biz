...
| **DMC** (Dirección Meteorológica de Chile) | DMC | Public | Official met service; surface stations | Hourly | `app/ingestion/public/dmc.py` (BA.1 — payload-mode parser; live mode deferred) |
